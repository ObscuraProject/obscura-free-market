...
import (
	...
	"github.com/ObscuraProject/obscura-free-market/modules/settings"
)
...
func ConfigureRouter(router *web.Router) *web.Router {
	...
	transactionAdminRouter.Post("/:transaction/release_historic", (*Context).AdminTransactionReleaseHistoric)
	transactionAdminRouter.Post("/:transaction/freeze_historic", (*Context).AdminTransactionFreezeHistoric)
