...
type ViewTransaction struct {
	*Transaction
	...
	IsFrozenHistoric   bool `json:"is_frozen_historic,omitempty"`
	IsReleasedHistoric bool `json:"is_released_historic,omitempty"`
...
func (t Transaction) ViewTransaction() ViewTransaction {
	...
	vt := ViewTransaction{
		...
		IsFrozenHistoric: t.IsFrozenHistoric(),
	}

	if t.IsFrozenHistoric() {
