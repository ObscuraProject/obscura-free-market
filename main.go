...
import (
	...
	_ "github.com/ObscuraProject/obscura-free-market/modules/util"
	"github.com/ObscuraProject/obscura-free-market/modules/webapp"
)
...
func maintainTransactions() {
	...
	webapp.TaskFreezeHistoricOldFrozenTransactions()
}
